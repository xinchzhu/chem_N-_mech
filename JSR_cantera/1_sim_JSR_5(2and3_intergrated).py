...
#########################################################################################################################
concentration = 'C3H6:0.0168, O2:0.0450, He:0.9382'																		#
pressu = 1.05 					#pressure integer                                                                       #
mech = 'AramcoMech3.0'			# mechanism file name (exclude .cti suffix)                                             #
T = np.array([800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100])		# list of temperatuers			    #
...
for temperature in T:
    ...
    timeHistory.to_csv('.\\timhis_JSR_%d.dat'%temperature)

    ## 提取目标物种的浓度数据 以O2 为例
    filename = 'timhis_JSR_%d'%temperature
